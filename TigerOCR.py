...
st.caption('¡Da vida a tus documentos con OCR - Tigers! Nuestra aplicación no solo convierte archivos PDF, PNG, JPEG y BMP en texto editable, sino que también ofrece un análisis detallado de la frecuencia de palabras. Simplifica la digitalización de tus documentos y obtén insights valiosos con OCR - Tigers.')
...
uploaded_file = st.file_uploader("Seleccionar un archivo 📁 (PDF, PNG, JPEG, BMP)", type=["pdf", "png", "jpeg", "bmp"])
